 ...
 * Responsibility: Render the UI for question-level statistical analysis.
 * Uses useAnalysisStats hook for all calculation logic.
 */
const AnalysisModal: React.FC<AnalysisModalProps> = ({
  ...
  const stats = useAnalysisStats(questions, students);
      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.header}>
          <div className={styles.titleContainer}>
            <span className={styles.title}>Imported Student Data Analysis</span>
          </div>
        </div>
        ...
        <div className={styles.content}>
            ...
            <table className={styles.table}>
              <tbody>
                ...
                <tr className={styles.row}>
                  ...
                  {questions.map((q) => (
                    <td key={q.key} className={styles.valueCell}>{q.bloomLevel}</td>
                  ))}
                </tr>
                ...
                <tr className={styles.row}>
                  ...
                  {questions.map((q) => (
                    <td key={q.key} className={styles.valueCell}>{q.questionNo}</td>
                  ))}
                </tr>
          ...
          <div className={styles.notes}>
            ...
            <p><strong>Standard Deviation</strong> - Take the mean of the data(secured marks for each question), then add the squared differences of the each data and mean.Further divide the result by count of data set, fetch the square root of the resulting value.</p>
